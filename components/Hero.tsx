...
export default function Hero() {
  ...
  const handleDownloadResume = async (e: React.MouseEvent<HTMLAnchorElement>) => {
    e.preventDefault()
    const url = `${BASE}/CV_DevOps_Nguyen_Tieu_Phung.pdf` // adjust path if your file is located elsewhere
    try {
      ...
      <div className="relative z-10 flex flex-col h-full gap-4">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="relative w-14 h-14 rounded-full overflow-hidden border-2 border-zinc-700 shadow-lg shrink-0">
            <Image src={`${BASE}/images/profile.png`} alt="Tieu_Phung" fill sizes="(max-width: 1024px) 100vw, 340px" className="object-cover" priority />
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 mt-auto pt-2">
          ...
          <a
            href={`${BASE}/CV_DevOps_Nguyen_Tieu_Phung.pdf`}
